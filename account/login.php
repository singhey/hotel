...
<div class="wrapper" style="width:450px;">
  <div class="container">
    ...
    <form action="/hotel/assets/requests/login_process.php" method="POST" class="form login">
    ...
    <p class="text--center">Not a member? <a href="/hotel/account/sign_up.php">Sign up now</a> <svg class="icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="assets/images/icons.svg#arrow-right"></use></svg></p>
